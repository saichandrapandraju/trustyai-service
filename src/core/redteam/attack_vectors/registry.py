...
JAILBREAK = AttackVector(
    ...
    datasets=["jailbreakbench", "garak.dan.AutoDANCached"],  # Builtin: 100 research-vetted jailbreak attempts from HF + Garak integration
    taxonomy_ids=["OWASP-LLM-01"],
...
HARMFUL_CONTENT = AttackVector(
    ...
    datasets=["jailbreakbench", "garak.dan.AutoDANCached"],  # Builtin: JBB covers harmful behaviors + Garak integration
