...
class Schema():
    """Mirror of Java Schema class."""
    items: Dict[str, SchemaItem]
    name_mapping: Dict[str, str]
    
    def __init__(self, items: Dict[str, SchemaItem] = None, 
    ...
    @classmethod
    def from_items(cls, items: Dict[str, SchemaItem]) -> "Schema":
        """Factory method to create Schema from items."""
