...
class SchemaItem():
    ...
    def __init__(self, type: DataType, name: str, column_index: int):
        self.type = type
        self.name = name
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, SchemaItem):
            return False
        return self.type == other.type and self.name == other.name and self.column_index == other.column_index
